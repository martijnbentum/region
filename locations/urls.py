...
urlpatterns = [
	...
	path('simple_map_search/',views.simple_map_search, 
        name='simple_map_search'),
	path('connection_view/',views.connection_view, name='connection_view'),
	path('connection_view/<str:text_identifier>/',
        views.connection_view, name='connection_view'),
