...
urlpatterns = [
	...
	path('ajax_popup/<str:markerid>/<str:main_instance_markerid>/',views.ajax_popup,name='ajax_popup'),
	...
	path('add_location_status/<int:pk>',views.add_location_status, name='add_location_status'),
	path('add_location_precision/',views.add_location_precision, name='add_location_precision'),
	path('add_location_precision/<int:pk>',views.add_location_precision, name='add_location_precision'),
	path('add_location_type/',views.add_location_type, name='add_location_type'),
	path('add_location_type/<int:pk>',views.add_location_type, name='add_location_type'),
]
