...
urlpatterns = [
	...
	path('podcast/',views.podcast_list,name='podcast_view'),
	...
	path('add_podcast/', views.edit_podcast, name='add_podcast'),
	...
	path('edit_podcast/<int:pk>', views.edit_podcast, name='edit_podcast'),
	path('edit_podcast/<int:pk><str:focus>', views.edit_podcast, 
        name='edit_podcast'),
	...
	path('detail_publication/<int:pk>',views.detail_publication,
		name='detail_publication'),
	path('d_periodical/<int:pk>',views.detail_periodical,
		name='detail_periodical'),
	path('d_text/<int:pk>',views.detail_text,
		name='detail_text'),
	path('detail_text/<int:pk>',views.detail_text,
		name='detail_text'),
	path('detail_podcast/<int:pk>',views.detail_podcast,
		name='detail_podcast'),
	path('d_podcast/<int:pk>',views.detail_podcast,
		name='detail_podcast'),
